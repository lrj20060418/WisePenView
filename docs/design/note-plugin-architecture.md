...
- 47 个 Note 专项测试，覆盖 registry、Markdown、projection、AI Diff、comments policy、side menu 和新笔记状态；
...
仓库已引入最小 Vitest 基础设施，测试文件与被测模块同域放置；当前 Note 专项共有 47 个测试，不依赖 dev/mock 服务。
